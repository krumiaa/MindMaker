...
-	[Download](https://www.unrealengine.com/marketplace/en-US/product/neurostudio-self-learning-ai) the Server Example project for UE – this includes the MindMaker Remote Server Application that will auto-launch when each project is run and the python source code for this. You can also download mindmaker_client.py from the MindMaker RemoteML Github Repo.
